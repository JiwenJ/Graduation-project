...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, d=1, act=True):
        ...
        # self.default_act = FReLU(c2)
        # self.default_act = SiLU_beta(c2)
        # self.default_act = FReLU(c2)
        # self.default_act = MetaAconC(c2)
        # self.default_act = AconC(c2)
        # self.default_act = FReLU_noBN_biasFalse(c2)
        # self.default_act = FReLU_noBN_biasTrue(c2)
